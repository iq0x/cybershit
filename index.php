        ...
        <div id="main">
            ...
            <?php
                ...
                ?> 
                    <div id="clouds"></div>
                    <div id="score">Score: <span id="score_value">0</span></div>
                    <div id="life">life: <span id="life_value">0</span></div>
                    <div id="ammo_maschinegun">ammo: <span id="ammo_maschinegun_value">0</span></div>
                    <div id="ammo_pirategun">ammo: <span id="ammo_pirategun_value">0</span></div>
           ...
           <div id="terminal">guest@cybershit:~$<input type="text" id="cmd" name="cmd"></div>
            <div id="menu">
                <div id="menu_box" onclick="alien_maschinegun()"><img src="img/maschinegun.gif" width="80%"></div>
                <div id="menu_box" onclick="alien_pirategun()"><img src="img/pirategun.gif" width="80%"></div>
                ...
                <div id="menu_box" onclick="get_info()"><img src="img/info.png" width="80%"></div>
            </div>
